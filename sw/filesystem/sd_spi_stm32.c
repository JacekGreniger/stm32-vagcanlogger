...
#define MMC_MISO GPIO_Pin_14
#define MMC_SCK GPIO_Pin_13
...
#define SELECT()        (void)GPIO_ResetBits(GPIOB, GPIO_Pin_12)    /* MMC CS = L */
#define DESELECT()      (void)GPIO_SetBits(GPIOB, GPIO_Pin_12)      /* MMC CS = H */
...
void SPI2_DMATransfer512B(u8 * p)
{
  /* DMA1 Channel5 configuration ----------------------------------------------*/
